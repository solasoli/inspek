  ...
  public function run()
  {
    ...
    DB::table('acl_menu')->insert([
      [
        ...
        'have_child'=>0,
        'level'=>2,
        'nama'=>'PeNomoran Surat',
        'url'=>'/pkpt/surat_perintah/Nomor',
        'slug'=>'sp_peNomoran_surat',
    ...
    DB::table('acl_menu')->insert([
      [
        ...
        'slug'=>'pemeriksaan_penentuan_sasaran_tujuan',
    ...
    DB::table('acl_menu')->insert([
      [
        ...
        'slug'=>'pemeriksaan_program_kerja_audit',
    ...
    DB::table('acl_menu')->insert([
      [
        ...
        'slug'=>'pemeriksaan_melakukan_audit',
    ...
    DB::table('acl_menu')->insert([
      [
        ...
        'level'=>2,
        'nama'=>'Laporan NHP',
        'url'=>'/pemeriksaan/irban/draft-nhp',
        'slug'=>'pemeriksaan_laporan_nhp',
    ...
    DB::table('acl_menu')->insert([
      [
        ...
        'level'=>2,
        'nama'=>'Laporan LHP',
        'url'=>'/pemeriksaan/irban/lhp-tinjut',
        'slug'=>'pemeriksaan_laporan_lhp',
    ...
    DB::table('acl_menu')->insert([
      [
        ...
        'have_child'=>0,
        'level'=>2,
        'nama'=>'Progres Tindak Lanjut',
        'url'=>'/#',
        'slug'=>'tinjut_progress',
        'created_at'=>'2020-11-10 16:15:52',
        'created_by'=>1,
        'updated_at'=>'2020-11-10 16:16:26',
        'updated_by'=>1,
        'deleted_at'=>NULL,
        'deleted_by'=>0,
        'is_deleted'=>0
