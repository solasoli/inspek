...
$(function() {
  $('#modal-form').on('show.bs.modal', function(e) {
    ...
    if (id > 0) { // form edit
      ...
      $("#form-jenis-pengawasan").attr('action', '{{url()->current()}}/edit/'+ id +'');
    }

    else { // form add
      $("#form-jenis-pengawasan").attr('action', '{{url()->current()}}/add');
    }
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Jenis Pengawasan</h4>
        <button type="button" class="close" data-dismiss="modal">&times;</button>
      </div>

      <!-- Modal body -->
      <div class="modal-body">
        <form id="form-jenis-pengawasan" class="form-layout form-layout-5" method="get" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="form-group row">
            <label class="form-control-label col-md-3 col-sm-3 col-xs-12">
              Nama Pengawasan <span class="required">*</span> :
            </label>
