     ...
     <div class="br-pagebody">
      ...
      <div class="tab-content">
        <div class="row">
          ...
          <div class="col-7">
           <button class="btn btn-primary" style="float: left; width: 150px; margin-right: 20px">CARI</button>
           <a href="/angka-kredit/perbandingan-penilaian"><button class="btn btn-danger">Perbandingan Penilaian</button></a>
           <a href="/angka-kredit/penetapan-dupak"><button class="btn btn-info">Penetapan AK</button></a>
       ...
       <table class="table table-striped table-bordered" style="border: 3px solid #dee2e6">
        ...
        <tr>
          ...
          <td width="11%"></td>
          <td width="11%"></td>
          <td width="11%"><a href="/angka-kredit/review-tim-penilai"><button class="btn btn-info w-100">Review</button></a>
            <a href="#" data-toggle="modal" data-target="#myModal"><button class="btn btn-success w-100 mt-1">Detail</button></a></td>
          </tr>
        </table>
