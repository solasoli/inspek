  ...
  <div class="modal-dialog modal-lg col-md-6" style="min-width: 600px">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title">Buat Angka Kredit Berdasarkan Unsur</h4>
        ...
        <form class="form-layout form-layout-5">
          <div class="form-group row">
            ...
            <div class="col-md-6 col-sm-6 col-xs-12">
              <select id='unsur_confirm' class="form-control">
                  @foreach($unsur as $row)
                    <option value='{{ $row->code }}'>{{ $row->nama }}</option>
                  @endforeach
              </select>
            </div>
          </div>
...
$(function() {
  ...
  $(".confirm-add").on('click', function(){
    location.href='{{ URL::to('/angka-kredit/perhitungan-angka-kredit/make/')}}/' + $('#unsur_confirm').val();
  })
});
</script>
@endsection
