                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            ...
                            return_button += `<a href='{{ URL::to('/pemeriksaan/audit') }}/edit/${row.id}' class="btn btn-xs btn-success"><i class='fa fa-pencil'></i> Kertas Kerja</a> `
                            @endif
                            
                            @if(can_access("program_kerja_audit", "edit"))
                            return_button += `<a href="{{ URL::to('/pemeriksaan/audit') }}/review/${row.id}" class="btn btn-xs btn-info"><i class="fa fa-star"></i> Review</a> `
                            @endif
