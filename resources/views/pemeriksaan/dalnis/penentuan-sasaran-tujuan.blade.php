      ...
      <div class="card bd-0 shadow-base" style="margin: 20px;">
       ...
       <div class="br-pagebody" style="margin-bottom: 10px">
        <ul class="nav nav-tabs" role="tablist">
          ...
          <li class="nav-item" style="width: 50%; text-align: center;">
            <a class="nav-link" data-toggle="tab" href="#menu1"><b>Sudah Di Setujui</b></a>
          </li>
        </ul>
...
<div class="row">
  <div class="col-sm-12">
   <table class="table table-bordered table-striped table-responsive dataTable no-footer" id="oTableApprove" style="width: 100%;" role="grid" aria-describedby="oTableApprove_info">
    <thead>
     <tr role="row">
