               ...
               <table class="table table-bordered table-striped responsive dataTable no-footer" id="oTable" style="width: 100%;" role="grid" aria-describedby="oTable_info">
                <thead>
                 <tr role="row">
                  ...
                  <th class="sorting" tabindex="0" aria-controls="oTable" rowspan="1" colspan="1" aria-label="Nomor SP: activate to sort column ascending" style="width: 0px;">Np. Surat Perintah</th>
...
<td class="text-center">
  <a href="/pemeriksaan/ketua/buat-program"><button class="btn btn-info mb-1" data-toggle="modal" data-target="#myModal">Buat Program Kerja Pemeriksaan</button></a>
