    ...
    <nav class="nav">
      ...
      <div class="dropdown">
        <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
          <span class="logged-name hidden-md-down">Super Administrator</span>
        ...
        <div class="dropdown-menu dropdown-menu-header wd-250">
          <div class="tx-center">
            ...
            <h6 class="logged-fullname">Super Administrator</h6>
          ...
          <ul class="list-unstyled user-profile-nav">
            ...
            <li><a href="index.html"><i class="icon ion-power"></i> Sign Out</a></li>
          </ul>
        </div><!-- dropdown-menu -->
      </div><!-- dropdown -->
    </nav>
...
<div class="modal-dialog modal-lg">
  <div class="modal-content">
    ...
    <div class="modal-body">
      <div id="editor" rowspan="5"><br>
      
    </div>
   <button class="btn btn-primary w-100" data-dismiss="modal">SIMPAN</button>
  </div>
</div>
</div>
</div>
...
<td class="text-center">
  <a href="buat_program.html"><button class="btn btn-info mb-1" data-toggle="modal" data-target="#myModal">Buat Program Kerja Pemeriksaan</button></a>
  <a href="detail_penentuan.html"><button class="btn btn-primary mb-1"><i class="fa fa-eye"></i> Detail</button></a>
  <a href="detail_penentuan2.html"><button class="btn btn-primary mb-1"><i class="fa fa-eye"></i> Detail SP</button></a>
...
<td><span class="text-success">Approved</span></td>
<td class="text-center">
  <a href="#"><button class="btn btn-info mb-1" data-toggle="modal" data-target="#myModal">Buat Program Kerja Pemeriksaan</button></a>
  <a href="detail_penentuan.html"><button class="btn btn-primary mb-1"><i class="fa fa-eye"></i> Detail</button></a>
  <a href="detail_penentuan2.html"><button class="btn btn-primary mb-1"><i class="fa fa-eye"></i> Detail SP</button></a>
  <button class="btn btn-warning"><i class="fa fa-edit"></i> Edit</button>
</td>
