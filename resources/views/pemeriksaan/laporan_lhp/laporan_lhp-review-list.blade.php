                            ...
                            <tbody>
                                ...
                                @foreach($data->audit_kertas_kerja as $row)
                                    <tr>
                                        ...
                                        <td>
                                            @if(can_access("laporan_lhp", "edit") && ($row->status->id >= 5 && $row->status->id <= 7))
                                                <a href="{{ URL::to('/pemeriksaan/laporan_lhp') }}/review/{{ $row->id }}" class="btn btn-xs btn-info"><i class="fa fa-star"></i> Review</a>
                                            @endif
