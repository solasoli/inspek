...
@section('content')
    ...
    <div class="br-mainpanel" id="panel-0">
        ...
        <div class="br-pagebody">
            ...
            <div class="row mg-t-20" style="margin-bottom: 40px">
                <div class="col-lg-12 widget-2 px-0">
                    <div class="card shadow-base">
                        ...
                        <div class="card-body">
                            <div id="wizard3">
                                <h3>Daftar Pemeriksaan Tujuan Tertentu</h3>
                                <section>
                                    <textarea name="daftarPemeriksaanTujuanTertentu" id="dptt" rows="10" cols="80"></textarea>
                                </section>
                                <h3>Ruang Lingkup</h3>
                                <section>
                                    <textarea name="ruangLingkup" id="ruangLingkup" rows="10" cols="80"></textarea>
                                </section>
                                <h3>Tujuan Audit</h3>
                                <section>
                                    <textarea name="tujuanAudit" id="tujuanAudit" rows="10" cols="80"></textarea>
                                </section>
                                <h3>Metodelogi Audit</h3>
                                <section>
                                    <textarea name="metodeAudit" id="metodeAudit" rows="10" cols="80"></textarea>
                                </section>
                                <h3>Tahapan Audit</h3>
                                <section>
                                    <textarea name="tahapanAudit" id="metodeAudit" rows="10" cols="80"></textarea>
                                </section>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <label for="data" class="w-100">
                                    <div class="card-header" style="display: none;">
                                        <p><input id="more_info6" name="more-info" type="checkbox" /> <input type="text"
                                                id="data1" name="">
                                </label></p>
                            </div>
                            <input autocomplete="off" class="form-control" style="display: none;" id="field1" name="prof1"
                                type="text" placeholder="" data-provide="typeahead" data-items="8" /><br>
                            <button id="b1" style="margin-left: 13px;width: 200px;" class="btn btn-success add-more"
                                type="button">+ Tambah Poin</button>
                            <hr>
                            <center><button class="btn btn-info" style="width:30%">SAVE AS DRAFT</button>&nbsp;<button
                                    class="btn btn-primary" style="width:30%">SIMPAN</button></center>
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(".add-more").click(function(e) {
                ...
                next = next + 1;
                var newIn = '<br /><label for="data" class="w-100"><div class="card-header" id="field' +
                    next + '" name="field' + next +
                    '"><p><input id="more_info5" name="more-info" type="checkbox" /> <input type="text" id="data1" name=""></label></p></div><input style="display:none" autocomplete="off" class="form-control" id="field' +
                    next + '" name="field' + next +
                    '" type="text" data-provide="typeahead" data-items="8">';
                var newInput = $(newIn);
                var removeBtn = '<button id="remove' + (next - 0) +
                    '" class="btn btn-danger remove-me" style="margin:10px; margin-bottom:0px" >Hapus</button>';
    ...
    <script type="text/javascript">
        ...
        for (var i = 0; i < brandImg.length; i++) {
            ...
            ckEdiloop.addEventListener("click", function(el) {
                ckEdImg = '<p><img src="' + this.src +
                    '" /></p>'; // La forma como las imágenes son envueltas en ckEditor
