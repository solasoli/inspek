                    ...
                    <div class="card shadow-base">
                        ...
                        <div class="card-body">
                            <div id="wizard3">
                                ...
                                <section>
                                    <textarea name="daftarPemeriksaanTujuanTertentu" class='text-wizard' id="dptt" rows="10"
                                        cols="80"></textarea>
                                </section>
                                <h3>Ruang Lingkup</h3>
                                <section>
                                    <textarea name="ruangLingkup" class='text-wizard' id="ruangLingkup" rows="10"
                                        cols="80"></textarea>
                                </section>
                                <h3>Tujuan Audit</h3>
                                <section>
                                    <textarea name="tujuanAudit" class='text-wizard' id="tujuanAudit" rows="10"
                                        cols="80"></textarea>
                                </section>
                                <h3>Metodelogi Audit</h3>
                                <section>
                                    <textarea name="metodeAudit" class='text-wizard' id="metodeAudit" rows="10"
                                        cols="80"></textarea>
                                </section>
                                <h3>Tahapan Audit</h3>
                                <section>
                                    <textarea name="tahapanAudit" class='text-wizard' id="tahapanAudit" rows="10"
                                        cols="80"></textarea>
                                </section>
                            </div>
                        </div>
