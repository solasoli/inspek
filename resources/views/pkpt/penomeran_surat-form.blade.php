...
<form class="form-layout form-layout-5" method="POST" action="{{URL::to('/pkpt/surat_perintah/rubah_Nomor')}}">
<!-- modal add -->
<div class="modal" id="NomorModal">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
          {{ csrf_field() }}
          <input type="hidden" value="" name='id' id='id_peNomoran'>
