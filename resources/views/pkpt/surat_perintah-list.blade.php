...
<br>
  <div class="row">
    <div class="col-lg-12 widget-2 px-0">
      <div class="card shadow-base">
        <div class="card-header">
          <h6 class="card-title float-left">Daftar Surat Perintah Khusus</h6>
          <div class="float-right">

            @if(can_access("pkpt_surat_perintah", "add"))
            <a class='btn btn-sm btn-success' href='{{url()->current()}}/add/3'><i class='menu-item-icon icon ion-plus'></i> Tambah</a>
            @endif
          </div>
        </div>
        <div class="card-body">
          <table class="table table-bordered table-striped responsive" id="oTableKhus" style="width:100%">
            <thead>
              <tr>
                <th>No. Surat</th>
                <!-- <th>Wilayah</th> -->
