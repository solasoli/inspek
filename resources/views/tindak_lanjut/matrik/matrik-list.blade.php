...
@section('content')
    ...
    <div class="br-pageheader pd-y-15 pd-l-20">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Matrik Tindak Lanjut</span>
        </nav>
    </div>

    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30">
        <h4 class="tx-gray-800 mg-b-5">Matrik Tindak Lanjut</h4>
    </div>
            ...
            $('#oTable').DataTable({
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        name: 'no_lhp',
                        render: function(data, type, row) {
                            return `<a target='_blank' href='{{ URL::to('/tindak_lanjut/matrik/detail') }}/${row.id}'>${data}</a>`
                        }
                    },
                    {
                        data: null,
                        ...
                        render: function(data, type, row) {
                            ...
                            @if(can_access("tindak_lanjut_matrik", "add"))
                            return_button += `<a href="{{ URL::to('/tindak_lanjut/matrik') }}/edit/${row.id}" class="btn btn-xs btn-warning"><i class="fa fa-pencil"></i> Tindak Lanjut</a> `
                            @endif

                            @if(can_access("tindak_lanjut_matrik", "edit"))
                            return_button += `<a href="{{ URL::to('/tindak_lanjut/matrik') }}/review/${row.id}" class="btn btn-xs btn-info"><i class="fa fa-star"></i> Review</a> `
                            @endif

                            return_button += `<a href="{{ URL::to('/tindak_lanjut/matrik') }}/detail/${row.id}" class="btn btn-xs btn-primary"><i class="fa fa-eye"></i> Detail</a>`
